...
<div className="container">
  ...
  <div className="page">
    ...
    <h4>Introduction</h4>
    <p>
    I am running for mayor, please help me get on the ballot, by sending me advice or support when the timer above reaches zero. Why? Because I have the best plans for immediately improving the city. No man is an island, I believe in the people of Chicago, which is why I think it would be an easy job. I want to push for the changes below, but priority number two is enabling and highlighting the best of us who actually get things done.
    ...
    <ul className="policies">
      <li className="policyItem"><b>No more Lead pipes:</b> We have so many lead pipes because the plumbing union helped pass a requirement to use lead pipes, decades after we knew lead was harmful. We should not be constrained to only using the same union that put lead into our bodies by force. Our biggest roadblock is the cost, and other cities do it much cheaper. We should be paying the companies that accept a competitive rate and get the job done. To lower costs more, an in-house team should be established. We have a lot pipes to replace, it will take many years. So we should directly hire the people we need. The in-house team competes with any outside companies, if we can scale it up for cheaper then we do.</li>
      <li className="policyItem"><b>Child care:</b> Subsidized child care. For all would be great if we have the money. But a more realistic start would be to help those who need it most first and to scale it up.</li>
      <li className="policyItem"><b>Housing:</b> Let's be honest, we rank last in housing growth. What we have isn't working. The top targets should be zoning reform and fixes to the approval/permitting process. There are some building code updates needed but we aren't as behind there. One example is allowing single stair apartment buildings.</li>
      ...
      <li className="policyItem"><b>Education:</b> No more lead pipes. No amount of lead is safe, it is a molecule that just sits there in your body, it doesn't go away. ~412,000 lead service lines. More than any other city in the US. Shame. The federal EPA rule requires Chicago to replace nearly 20,000 pipes per year starting in 2027, but Chicago's submitted plan targets completion by 2076, putting it 30 years behind the federal deadline. Among the five U.S. cities with the most lead pipes: Chicago, Cleveland, New York, Detroit, and Milwaukee, only Chicago has yet to adopt the latest federal deadline. Two-thirds of Chicago's youngest children, under age six, live in homes with tap water containing detectable levels of lead. Chicago pays 3-6x more per line than Detroit and 6-7x more than Milwaukee — despite the city's own website acknowledging private owners can hire it done for $2,500-$5,000 (Chicago city average is $30,000)</li>
      <li className="policyItem"><b>Transportation:</b> More frequent trains and buses, protected bike lanes, and smarter traffic systems. We don't need a car vs everyone else battle, we can help both at once. More people will opt for alternative transit, reducing traffic. Smarter traffic light systems can save drivers from pointless waiting, the most frustrating kind. For example, many left turn signals in the city do not check if there are waiting left turners or not. This makes me really sad, because my hometown suburb had lights that checked for waiting cars. 3 decades later, and I am regularly waiting for no one with lights dumber than what we had in the burbs. My sci-fi-loving brain could never have imagined that. There is a lot of room for improvement.</li>
      <li className="policyItem"><b>Transportation:</b> Get rid of advertising everywhere, replace it with content. All El digital signs should show the incoming trains at all times. Public ads are nonconsensual brain space interference. What if instead we let people sign up to decorate a train car instead?</li>
      <li className="policyItem"><b>Transportation:</b> Bounty system for reporting traffic violations. It makes no sense to rely upon the police when everyone in the city has a camera and an interest in clear streets. I feel for delivery drivers, we added a new system to the city and provided zero services for them. No help. They are forced onto busy streets with few choices. But we need to establish real laws around protecting bike lanes and day-lighting (no cars blocking the view at intersections). Delivery drivers do what they have to, they will adjust to rules. Hopefully, we get more bike-based food delivery. (I want the delivery apps to include an option for requesting bike delivery. Uber does this for electric cars)</li>
      ...
      <li className="policyItem"><b>Cost Reforms:</b> More in-house operations versus outside vendors. We should progressively minimize costs by developing the services we need, where we can.</li>
    ...
    More trains and buses. In rush hour, trains should be coming every 5-10 minutes. The other day I arrived to Merchandise Mart and a packed platform a little after 5 on a weekday, and the next train didn't come for 20 minutes. Taking a train at rush hour should be a pleasant experience, not a stressful packing of people. The number of people commuting is not a surprise, any crowded route should get more trains. God forbid we over-serve the people.
      ...
      <p>
      All El signs will ALWAYS show the next incoming trains for each line they are serving. No notices or ads blocking the whole screen. All you need is a color and a number(minutes), there should always be space for them. (ads are literal brain AIDS and a consent violation).
      </p>
      <p>
