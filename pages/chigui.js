...
<div className="container">
  ...
  <div style={{display:'flex', flexDirection:'column', justifyContent:'center', alignItems:'center', marginBottom: '5%'}}>
    ...
    <p>
      Below you will find my Chicago Mayoral platform. These are my plans loosely described, I want to make sure all important topics are covered. That's priority #1. Editing is ongoing but some are still in note form. I'm currently researching urban design. Please let me know if you have concerns that are not addressed or if you have any particular areas you want to see more of.
    </p>
