...
<div className="container">
  ...
  <div style={{display:'flex', flexDirection:'column', justifyContent:'center', alignItems:'center', marginBottom: '5%'}}>
    ...
    <ul style={{margin: '2% 5%', listStyle: 'none', padding: 0}}>
      ...
      <li className="policyItem"><b>Transportation:</b> More frequent trains and buses, protected bike lanes, and smarter traffic systems. No more waiting for lights with no one there.</li>
