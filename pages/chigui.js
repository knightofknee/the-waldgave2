...
export default function OpenChicago() {
  ...
  const phases = [
    ...
    { name: 'Secret Invasion', isActive: true },
...
<div className="container">
  ...
  <div className="page">
    ...
    <nav className="toc">
      ...
      <br />
      <b>Deep dives:</b> <a href="#education">Education</a> · <a href="#transportation">Transportation</a> · <a href="#bubi">BUBI</a> · <a href="#process">Process Changes</a> · <a href="#parking-rant">The Parking Rant</a>
    </nav>
    ...
    <div className="tierBox">
      <p><b>How it adds up.</b> Every plan below lands in one of three buckets, so nobody has to ask "how do you pay for it" twice. <b>Bucket&nbsp;1, costs almost nothing:</b> traffic signal retiming, school start times, crosswalk daylighting, noise cameras, surveillance rules, ending the aldermanic zoning veto. These are execution problems, not money problems, so they go first. <b>Bucket&nbsp;2, pays for itself or better:</b> parking reform, the land value tax shift, the Bears deal, doing city work ourselves instead of overpaying vendors, lead pipes (the federal loans are already secured, and the avoided brain damage pays dividends forever). <b>Bucket&nbsp;3, costs real money and is worth it:</b> childcare, guaranteed income, transit frequency, mental health clinics. Bucket&nbsp;3 waits its turn behind honest revenue, which is exactly why the Budget &amp; Pensions plank below exists. You don't get nice things by pretending the hole isn't there.</p>
    </div>

    <h4 className="groupHead" id="health-home">Health &amp; Home</h4>
    <ul className="policies">
      ...
      <li className="policyItem"><b>Housing:</b> Let's be honest about the score: in 2023 Chicago permitted 1.36 new homes per 1,000 residents; the other nine biggest US cities averaged 4.71. Now Chicago rents are rising faster than any other top-10 metro. That's not a mystery, it's supply and demand: we are choosing scarcity, and other cities have run the experiment in reverse: <a href="https://www.pew.org/en/research-and-analysis/articles/2026/03/18/austins-surge-of-new-housing-construction-drove-down-rents">Austin built so much housing that rents fell ~7% in a single year</a>, and Minneapolis ended single-family-only zoning and held rent growth near 1%. The city's own <a href="https://www.chicago.gov/city/en/depts/mayor/press_room/press_releases/2024/april/cut-the-tape.html">"Cut the Tape" report</a> found approvals that should take 3-6 months routinely taking 9 or more. Fix zoning and permitting first. Update the building code where we actually lag, like legalizing single-stair apartment buildings, which Seattle has allowed since 1977 (a redundant second staircase costs $200k-$400k per building and eats the floor space that could be family-sized apartments; Washington, Colorado, and Tennessee have already moved, and an ordinance is sitting in our own City Council). Protect the two-flat, Chicago's native affordable housing: two-to-four-flats are <a href="https://www.housingstudies.org/releases/characteristics-2-4-stock-chicago-neighborhoods/">about 27% of our housing stock</a>, and we <a href="https://www.housingstudies.org/releases/patterns-lost-2-4-unit-buildings-chicago/">lost nearly 4,800 of those buildings from 2013 to 2019 alone</a>, mostly deconverted into bigger single-family homes. We <a href="https://www.chicago.gov/city/en/depts/doh/provdrs/homeowners/svcs/adu-ordinance.html">finally legalized granny flats citywide in 2025</a> (46 to 0, a real win), but in single-family zones an ADU still needs your alderman's personal blessing, which tells you who actually runs zoning here (see Process Reforms). And bring back SROs: Chicago demolished <a href="https://www.pew.org/en/research-and-analysis/issue-briefs/2025/07/how-states-and-cities-decimated-americans-lowest-cost-housing-option">81% of its single-room-occupancy housing between 1960 and 1980</a>, over 31,000 of the cheapest homes we ever had, and then acted surprised about the people in the parks. The end goal: define the ideal city block and write a code that delivers it. Wards get flexibility, but universal standards are how we stop NIMBY bimbly bullshit at every turn.</li>
      <li className="policyItem"><b>Homelessness:</b> Ask people who avoid shelters why: they aren't safe or private, and what few belongings you have get stolen. Private rooms beat warehouse shelters on every measured outcome, and Chicago demolished over 31,000 of them (see Housing). So the plan is boring on purpose: bring back SROs with a per-ward minimum based on population, and copy what's working: <a href="https://www.nytimes.com/2022/06/14/headway/houston-homeless-people.html">Houston moved 25,000+ people from the streets into homes</a> and cut homelessness by more than half since 2011 with permanent housing and one coordinated intake system. No miracle, just management. Chicago already merged its migrant and homeless shelters into one system in 2024 (good). Now point that system at private rooms instead of cots. Safety inside cheap housing is an engineering problem, not a reason to do nothing: the <a href="https://newrepublic.com/article/161808/ewing-annex-hotel-housing-crisis-chicago">Ewing Annex Hotel</a> ran on the Harold's Chicken principle: a threat of violence is something we can work around with a rotating door and bullet-proof glass. A great city doesn't leave people sleeping in the parks and then act surprised.</li>
      <li className="policyItem"><b>Child care:</b> Every Chicago 4-year-old is already eligible for free full-day pre-K, genuinely good. The hole is ages 0-3: infant care in Illinois runs <a href="https://www.epi.org/publication/child-care-affordability/">about $16,400 a year</a>, and Chicago-area costs rose ~30% from 2020 to 2024. Subsidize care starting with the families who need it most, and scale up. This isn't charity, it's the best investment on the public books: Nobel laureate James Heckman, a UChicago guy, measured a <a href="https://heckmanequation.org/resource/13-roi-toolbox/">13% annual return</a> on birth-to-five programs. When Quebec made child care universal and cheap, maternal employment climbed to ~87%, among the highest rates in the world.</li>
      <li className="policyItem"><b>Guaranteed Income:</b> Not speculation anymore. The receipts: Chicago ran one of the largest guaranteed income pilots in the country (5,000 households at $500/month, launched 2022). Cook County ran its own two-year pilot, and in November 2025 became <a href="https://economicsecurityproject.org/news/cook-county-becomes-first-government-body-in-nation-to-make-guaranteed-income-permanent/">the first government in America to make guaranteed income permanent</a>, with the first permanent payments rolling out in 2026. Stockton's famous pilot saw recipients land <a href="https://www.stocktondemonstration.org/employment">full-time jobs at over twice the control group's rate</a>. And Chicago? We announced a second round (the Chicago Empowerment Fund, another 5,000 households), opened applications in November 2024, and then <a href="https://www.wbez.org/city-hall/2024/12/06/axing-a-guaranteed-income-program-to-fill-the-citys-budget-hole-will-cost-chicago-long-term-advocates-say">cut the funding to patch the budget hole while people were still applying</a>. We proved it works, and then we quit mid-application. I want to finish the job, and I want the bigger version too. That's BUBI, full section below.</li>
    </ul>

    <h4 className="groupHead" id="safety">Safety</h4>
    <ul className="policies">
      <li className="policyItem"><b>Public Safety - Solve the Shootings:</b> Start with the good news nobody believes: <a href="https://www.chicago.gov/city/en/depts/mayor/press_room/press_releases/2025/december/2025-year-in-review.html">416 homicides in 2025, the fewest since 1965</a>. Now the bad news nobody talks about: Chicago has <a href="https://www.civicfed.org/civic-federation/blog/chicago-police-department-staffing-analysis">among the most police per capita of any big US city</a>, roughly double the national average, and yet <a href="https://chicago.suntimes.com/the-watchdogs/2025/03/14/non-fatal-shootings-clearance-rate-chicago-police-cpd-statistics">only about 6% of nonfatal shootings end in an arrest</a>. Since 2018, more than 19,000 people have been shot in this city and roughly 1,200 shooters arrested. You can shoot someone here and expect to get away with it. That is the real deterrence crisis, and no amount of tough talk touches it. CPD touts a 71% homicide clearance rate for 2025, a 13-year high, but <a href="https://citythatworks.substack.com/p/getting-away-with-murder">most of the recent gains are "exceptional" clearances</a>, cases closed with nobody ever charged. We are not under-policed; we are mis-allocated. The plan: detectives, detectives, detectives. <a href="https://www.chicagopolice.org/news/perf-2025-update/">PERF found our homicide detectives carrying roughly double the recommended caseload</a> and left CPD 89 specific recommendations. Implement them, and move the spending needle from stops to solves. Scale what's proven: UChicago's <a href="https://crimelab.uchicago.edu/resources/readi-paper/">READI trial</a> (jobs plus therapy for the highest-risk men) cut shooting-and-homicide arrests 79% among the men reached through street outreach, with benefits worth 4 to 18 times the cost. And take mental-health calls off cops' plates entirely (next planks). Chicago just proved violence can fall fast. The job now is making it stick by actually solving the crimes that remain.</li>
      <li className="policyItem"><b>Cameras with Real Oversight:</b> Surprise: Chicago is already <a href="https://www.technologyreview.com/2026/02/23/1132740/inside-chicago-surveillance-panopticon/">the most-surveilled big city in America</a> (CPD can tap into 32,000+ cameras), but unlike San Francisco, Seattle, Boston, and New York, we have no surveillance transparency ordinance. The cameras exist; the rules don't. I want them working FOR us, with the oversight in writing: open-source access rules, every viewing logged and auditable, ward-level buy-in, and automatic cancellation for tech that fails its own evaluation. ShotSpotter is the proof that rule works: the <a href="https://igchicago.org/2021/08/24/oig-finds-that-shotspotter-alerts-rarely-lead-to-evidence-of-a-gun-related-crime-and-that-presence-of-the-technology-changes-police-behavior/">Inspector General found only 9.1% of alerts</a> ever led to evidence of a gun crime, and the contract died in 2024. Let me be precise about the lesson: the science is sound: microphones can absolutely detect and triangulate gunfire. What failed was a black-box vendor product that never showed its data and never turned into evidence or arrests (<a href="https://comptroller.nyc.gov/newsroom/nypds-shotspotter-gunshot-detection-system-overwhelmingly-sends-officers-to-locations-where-no-confirmed-shooting-occurred-new-audit-uncovers">New York's audit found the same thing</a>). So build the next one our way: developed in-house or by a contractor who works for US, open about its numbers, judged on evidence recovered. And the city keeps the data, period. We already know what unaccountable data does here: CPD's old gang database held <a href="https://igchicago.org/2019/04/11/oig-finds-a-lack-of-controls-and-procedural-fairness-protections-in-the-chicago-police-departments-gang-database-that-undermine-public-trust-and-confidence-in-the-police/">134,000+ people, 91% of them Black or Latino</a>, some with "occupation: scum bag" typed into the file. No notice, no appeal, shared with 500+ outside agencies, until the oversight board scrapped it. Never again. Support officers with live help instead of after-the-fact blame, and let the auditors watch the watchers.</li>
      <li className="policyItem"><b>Mental Health Clinics:</b> The city ran 12 public mental health clinics; in 2012 <a href="https://www.npr.org/2012/04/27/151546358/closure-of-chicago-mental-health-clinics-looms">Rahm closed half of them to patch a budget gap</a>. The shuttered six served ~5,300 people, mostly Black and Latino patients. It took a decade of organizing (Treatment Not Trauma) to start undoing it: a new Pilsen hub in 2024, <a href="https://blockclubchicago.org/2025/01/09/roseland-mental-health-clinic-reopens-as-city-crisis-assistance-expands/">Roseland reopened in January 2025</a>, so we're back up to 7. Keep going, and pair the clinics with the thing that actually changes the street: non-police crisis response. Chicago's CARE teams answered 1,500+ mental-health calls from 2021-2024 with zero arrests, and <a href="https://mindsitenews.org/2026/05/30/care-team-expands-to-all-chicago-for-now/">finally expanded citywide in 2026</a>, but they still catch a sliver of the calls, on limited hours. Denver's version handled its first 1,400+ calls with zero arrests and police backup never once needed, and a <a href="https://news.stanford.edu/stories/2022/06/stanford-study-shows-benefits-reinventing-911-responses">Stanford study found reported low-level crime fell 34%</a> in served neighborhoods at about a quarter of the cost of a police response. My improvement: make CARE 24/7 with enough teams that dispatchers treat "person in crisis" as a health call by default, route follow-ups through the clinics so nobody bounces from crisis to crisis, and publish the response data monthly. Cops shouldn't be the city's therapists of last resort, and most cops would agree.</li>
      <li className="policyItem"><b>Street Safety:</b> Chicago adopted Vision Zero in 2017 and promised zero traffic deaths by 2026; we <a href="https://blockclubchicago.org/2026/02/23/chicago-traffic-deaths-reach-a-9-year-low-but-funding-cuts-could-threaten-progress/">ended 2025 at 100</a>, the lowest since 2016 and down 46% from the 2021 peak, but 100 is not zero, and the playbook that got deaths falling is sitting right here. A <a href="https://www.sciencedaily.com/releases/2019/05/190529113036.htm">13-year study of 12 cities</a> found that protected bike lanes cut road deaths by ~44% for EVERYONE, drivers included, because they calm the whole street. Chicago is up to ~70 miles of protected lanes; keep building the north-south and east-west spines and let crash data drive the map. Daylighting is even easier: Illinois law already bans parking within 20 feet of a crosswalk, but Chicago's municipal code exempts ordinary cars from it. Adopt the state rule: <a href="https://www.inquirer.com/transportation/hoboken-zero-traffic-deaths-lessons-philadelphia-council-20251029.html">Hoboken daylighted its intersections and hasn't buried a traffic victim in 8 years</a>. And since everyone in this city carries a camera, let residents report vehicles blocking bike lanes and crosswalks and take a cut of the fine. Delivery drivers aren't the enemy. We bolted a whole new industry onto our streets and gave it zero infrastructure. Give them protected lanes and a bike-delivery option in the apps, and they'll use both.</li>
    ...
    <h4 className="groupHead" id="money">The Money</h4>
    <ul className="policies">
      <li className="policyItem"><b>Parking Lease Reform:</b> In 2008 the city sold 75 years of our parking meters for $1.15 billion. The council approved the 500-page deal about 72 hours after seeing it, and the city's own <a href="https://igchicago.org/wp-content/uploads/2011/03/Parking-Meter-Report.pdf">Inspector General found we were underpaid by roughly $974 million</a>. The investors recouped their entire purchase price in under 10 years; through 2025 they've collected about $2.2 billion, they set a revenue record in 2024, and there are 58 years left on the lease. On top of that, we've paid THEM $160+ million in "true-up" penalties, plus $25 million for COVID street closures. Right now the owners are trying to <a href="https://blockclubchicago.org/2026/07/14/could-the-city-still-buy-back-control-of-its-parking-meters/">flip the lease for $2.5 billion</a>, and the council fight is live. This is the moment to get our streets back. Long term, meter pricing should be demand-based: if your street never fills past 70%, your parking should be cheap or free. Full rant with receipts at the bottom of this page.</li>
      <li className="policyItem"><b>The Budget &amp; Pensions:</b> Here is the hole with no makeup on it: Chicago's four pension funds are <a href="https://news.wttw.com/2026/07/06/chicago-s-pension-debt-increased-2025-364b-city-analysis">$36.4 billion short and about 28% funded</a>, the <a href="https://www.governing.com/finance/chicago-confronts-35b-pension-crisis-among-nations-worst">worst-funded pension system of any major American city</a>, with the police and fire funds sitting near 25 cents on the dollar. The city paid $2.9 billion into pensions in 2025; add debt service and <a href="https://www.civicfed.org/chicagos-fy2026-adopted-budget">about 40 cents of every operating dollar goes to the past</a> instead of the present (New York's number is about 17). The 2026 budget closed a record $1.19 billion gap, <a href="https://www.chicago.gov/city/en/depts/mayor/press_room/press_releases/2025/august/FY2026-budget-forecast.html">2027's projected gap is another $1.16 billion</a>, the rating agencies downgraded us twice in two days this February, and Springfield made it worse: a 2025 police-and-fire benefit sweetener quietly added <a href="https://news.wttw.com/2025/08/05/bill-boosting-police-firefighter-pensions-made-chicago-s-dire-financial-condition-worse">roughly $7 billion in required contributions over 30 years</a>. I won't pretend a mayor waves this away, so here are my rules instead. One: make the full advance pension payment every single year, no games. Skipping it is borrowing from your own future at loan-shark rates (<a href="https://chicago.suntimes.com/city-hall/2026/01/21/chicago-city-council-pension-advance-half-payment-mayor-brandon-johnson">the city paid only half of it this January</a>; that is how you get downgraded). Two: no one-time revenue patching recurring holes; that's the parking meter move again, just smaller. Three: every program on this page is tiered honestly (see How It Adds Up): cheap stuff ships first, expensive stuff waits for real revenue, and the revenue conversation happens in the open with published models anyone can check. Four: growth is the only painless fix: every vacant lot filled and every new neighbor housed improves the pension math without raising anyone's taxes. Five: pension reform gets paired with an income tax; the two gotta come together. You don't ask workers to give ground without new honest revenue on the table, and you don't ask for a new tax while the hole keeps growing. This debt took four decades of bipartisan lying to build, and anyone promising a four-year fix is just the newest liar. The honest promise: stop digging, publish everything, leave the trajectory pointed up.</li>
      <li className="policyItem"><b>Cost Reforms:</b> Build in-house capacity instead of defaulting to vendors and consultants. Chicago's outsourcing record speaks: the parking meters (see above), the Skyway (leased for $1.83 billion, and investors later resold the lease for $2.8 billion), and four downtown garages that ended with the city paying a <a href="https://chicago.suntimes.com/news/the-watchdogs-city-halls-62-million-blunder/">$62 million arbitration award</a>. Cities that insourced, like Atlanta's water and Fort Wayne's fleet, got better service for less. Every service we can competently run ourselves is leverage against every future bad deal.</li>
      <li className="policyItem"><b>Chicago Bears Deal:</b> Taxpayers still owe roughly $356 million on the 2003 Soldier Field renovation (payments run through 2032), and the Bears asked for ~$2.4 billion more in public money for a lakefront dome while being worth about $8.8 billion. When <a href="https://www.chicagobooth.edu/review/what-economists-think-about-public-financing-sports-stadiums">top economists were polled</a>, including 7 Nobel winners, 83% agreed stadium subsidies cost taxpayers more than they return. Almost nothing gets economists to agree like that. My deal: the Bears get land and cooperation, they pay for their own stadium, and whatever value the public contributes comes back as a contractual share of the money. The NFL bans cities from owning equity (Green Bay and its 538,967 citizen-shareholders got grandfathered in), but teams share stadium revenue with public authorities all the time through their leases: rent, naming rights, ticket surcharges. So structure the public's return as a contract, not a share certificate; Chicago accounting firms can make independent estimates of fair value. As a bonus, I want to see a player alumni ownership group; the team could really use some check on shitty ownership decisions. And if the league objects to the public simply getting paid back, make them say that out loud.</li>
    </ul>

    <h4 className="groupHead" id="getting-around">Getting Around</h4>
    <ul className="policies">
      <li className="policyItem"><b>Transit Frequency:</b> At the worst of the operator shortage, the <a href="https://wgntv.com/news/chicago-news/cta-lags-comparable-cities-in-ridership-recovery-staffing-shortage-remains-a-crisis/">Blue Line ran as little as 44% of its scheduled trains</a>. Service is mostly restored, and Springfield finally passed $1.5 billion a year in transit funding (December 2025), so the excuses are gone. Rush-hour trains every 5-10 minutes, and buses you don't need a prayer to catch. (The other day I arrived at Merchandise Mart to a packed platform a little after 5 on a weekday, and the next train didn't come for 20 minutes. God forbid we over-serve the people.) Frequency is the highest-leverage move in transit: the research consistently finds a 10% increase in frequency drives roughly a 9% increase in ridership. The CTA's new Frequent Network, 20 bus routes at 10-minute headways, is the right idea; extend it until "just missed it" stops mattering.</li>
    ...
    <ul className="policies">
      ...
      <li className="policyItem"><b>CPS - The Board and the Books:</b> The elected school board this city fought decades for arrives exactly on schedule with the next mayor: <a href="https://www.chalkbeat.org/chicago/2026/05/27/51-candidates-running-for-the-2026-chicago-school-board-election/">the final seats are on the November 2026 ballot</a>, and the first fully elected 21-member board is seated January 2027. So the next mayor's job is not to puppeteer the board; it's to hand it a district that isn't on fire. The fire: CPS closed a $734 million deficit last year, is closing <a href="https://news.wttw.com/2026/07/22/chicago-board-education-members-weigh-how-close-732m-budget-gap">another $732 million gap right now</a>, currently via roughly 760 teacher layoffs, and carries <a href="https://www.chalkbeat.org/chicago/2025/08/26/chicago-public-schools-debt-census-data/">nearly $10 billion in debt, over $28,000 per student and among the most of any district in America</a>, at junk ratings, with debt service near $1 billion a year. Enrollment is <a href="https://news.wttw.com/2025/09/25/cps-enrollment-drops-9000-students-after-back-back-years-gains">down about 22% since 2011</a> (316,000 students and falling), which is the brutal math behind every half-empty building. On closings, hear me clearly: 2013's closure of 50 schools was the largest in US history, and <a href="https://chicago.suntimes.com/2018/5/22/18348245/study-cps-2013-closings-didn-t-keep-promises-of-better-academic-opportunities">UChicago's Consortium found the results for displaced kids were "neutral at best, and negative in some instances"</a>. That is what closure-by-politics looks like. Some consolidation is coming either way (you can't run every half-empty building forever), so here is my rule for it: before any school closes, the city publishes exactly what happens to every affected kid: where they'd go, how they'd get there, what programs they'd gain or lose, plus the steps we'll take to soften the damage, and the numbers we'll track afterward to prove we didn't cause it. The burden of proof sits on the closers, in public, before the vote. Equality through math means showing the math. And keep perspective: the <a href="https://www.chalkbeat.org/chicago/2023/10/31/23940755/chicago-public-schools-graduation-rates-class-of-2023/">graduation rate is at a record ~84%</a>, roughly double the late-1990s rate, so don't let anyone tell you nothing works. Teachers (above) are the investment; the board belongs to the voters; the books are the job.</li>
    ...
    <h4 className="groupHead" id="quality">Quality of Life</h4>
    <ul className="policies">
      <li className="policyItem"><b>Public Bathrooms:</b> Chicago has fewer than 500 publicly accessible restrooms for 2.7 million people. The city's FIRST public toilet (first pushed in council in 2021, finally contracted in 2024) is <a href="https://blockclubchicago.org/2025/10/23/chicagos-first-city-backed-public-restroom-will-open-in-2026-ald-says/">scheduled to open at the end of 2026</a>. Five years, one toilet. The unit costs under $500k and the vendor maintains it for free. A great city lets you exist in public without buying a coffee. This is the cheapest dignity money can buy.</li>
      <li className="policyItem"><b>Night Sky Initiative:</b> Chicago is the <a href="https://therevelator.org/cities-ranked-light-pollution/">4th-brightest metropolitan area on Earth</a>, 4.5 times brighter than the average city. Under a dark sky you'd see ~2,500 stars; from a Chicago sidewalk, maybe a dozen. Our new LED streetlights already point downward (good), but the city chose a blue-heavy color temperature; one physicist estimated warmer amber LEDs would have cut our light pollution by at least half. Fixtures and phasing: that's the whole project. Give the kids of Chicago the Milky Way, and highlight a Chicago star (the human kind) every night alongside the count of celestial ones we've won back, a daily open mic of sorts. Pair that with the safety-net planks above and we can transform the starving artist.</li>
      <li className="policyItem"><b>Trees That Actually Arrive:</b> Trees are infrastructure: shade, flood absorption, cleaner air, calmer streets. Chicago's canopy is around 16%, and the tree map is the same map as every other inequality: Forest Glen sits near <a href="https://illinoisanswers.org/2026/06/26/city-leaders-tout-tree-planting-bonanza-but-neighborhood-disparities-persist/">46% cover while parts of the South and Southwest sides sit under 12%</a>. The city's <a href="https://www.chicago.gov/city/en/depts/mayor/press_room/press_releases/2025/november/our-roots-90-percent.html">Our Roots program</a> (75,000 trees, ~90% planted) is real progress with a designed-in flaw: planting chases 311 requests, and the city's own foresters admit wealthier residents file more requests, so even the equity program drifts north. Anyone can order trees; delivering them where they're needed is the actual job. Flip the default: plant block-by-block in the lowest-canopy wards unless a resident opts out, publish the canopy map live, and measure success in shade over Brighton Park, not totals in a press release.</li>
      <li className="policyItem"><b>Environmental Justice - the Toxic Doughnut:</b> A history lesson I got for free, so you get it too: Hazel Johnson, an Altgeld Gardens mother, spent the 1980s mapping the landfills and polluters ringing her neighborhood. She called it <a href="https://www.chicago.gov/city/en/depts/mayor/press_room/press_releases/2025/april/Hazel-Johnson-Cumulative-Impacts-Ordinance.html">"the toxic doughnut"</a>, and more or less founded the environmental justice movement from the South Side. The pattern she named is still city policy: when General Iron's metal shredder got pushed out of wealthy Lincoln Park, the city helped move it to the Latino Southeast Side, and it took a month-long hunger strike to force the permit denial in 2022. A federal investigation then concluded that <a href="https://chicago.suntimes.com/2022/7/19/23270084/hud-civil-rights-general-iron-polluters-black-latino-neighborhoods-lightfoot">Chicago's own planning practices steer polluters into Black and Latino neighborhoods</a>; HUD made the city sign a binding reform agreement. The receipts are in our kids' lungs: pediatric asthma ER visits on the South Side run <a href="https://pmc.ncbi.nlm.nih.gov/articles/PMC11306379/">about triple the state rate</a>. The fix is already written and named after her: the Hazel M. Johnson Cumulative Impacts Ordinance, which would finally make permits weigh the pollution a neighborhood already carries, was introduced in April 2025 and has been stalled in council ever since. Pass it, and enforce the HUD agreement like a contract instead of a press release.</li>
      <li className="policyItem"><b>Grocery Deserts:</b> Roughly 600,000 Chicagoans live without easy access to fresh food, and it's getting worse: <a href="https://blockclubchicago.org/2026/07/26/as-7-save-a-lot-stores-close-south-and-west-side-neighbors-increasingly-worry-about-grocery-options-im-devastated/">seven more South and West Side groceries closed in July 2026</a>. Chicago actually studied a city-owned grocery store; the 2024 feasibility study came back <a href="https://economicsecurityproject.org/wp-content/uploads/Feasibility-of-Municipally-Owned-Grocery-Stores.pdf">"necessary, feasible and implementable"</a>, and then the city skipped the state grant deadline and <a href="https://blockclubchicago.org/2025/02/12/city-pitches-idea-for-public-market-after-dropping-plans-for-city-owned-grocery-store/">quietly downgraded the plan to a "public market"</a>. Classic. Meanwhile New York is running the experiment for us: Mamdani's five city-owned stores are funded, with <a href="https://www.npr.org/2026/07/28/g-s1-135938/mamdani-nyc-grocery-stores">the first opening in the Bronx next year</a> promising ~30% cheaper staples. My position is the engineering position: watch the data. If New York's stores hit their price and access targets, our feasibility study is already on the shelf: dust it off and go. If they faceplant, we learned for free, and we push the cheaper levers meanwhile: fast-track permits and incentives for grocers in low-access areas, back co-op models, and stop letting one chain's exit erase a neighborhood's produce aisle.</li>
    </ul>

    <h4 className="groupHead" id="people">Our People</h4>
    <ul className="policies">
      <li className="policyItem"><b>Sanctuary City:</b> This isn't new politics; it's Chicago tradition. <a href="https://news.wttw.com/2025/01/13/wttw-news-explains-how-did-chicago-become-sanctuary-city">Harold Washington signed the first order in 1985</a>, and every mayor since, both Daleys and Rahm included, kept it. More than <a href="https://www.wbez.org/immigration/2025/09/12/chicago-immigrant-population-growth-trump-immigration-enforcement">one in five Chicagoans is an immigrant</a>; they're over a third of our entrepreneurs and nearly half our manufacturing workforce, paying billions in taxes into the very pensions above. The research is boringly one-sided: <a href="https://www.americanprogress.org/article/the-effects-of-sanctuary-policies-on-crime-and-the-economy/">sanctuary counties have LOWER crime and stronger economies</a> than comparable non-sanctuary counties. Then came 2025: masked federal agents ran "Operation Midway Blitz" through our neighborhoods, and the government's own numbers fell apart in court: <a href="https://www.axios.com/local/chicago/2025/12/08/dhs-claims-contradicted-video-court">most people detained had no criminal record</a>, and at one processing center DHS's own ratings tagged 16 of 614 detainees as high public-safety risks. A federal judge found <a href="https://abc7chicago.com/post/ice-chicago-federal-judges-report-shares-details-use-force-during-operation-midway-blitz/18184325/">"widespread misrepresentations"</a> after bodycam footage contradicted agents' sworn accounts; the <a href="https://www.scotusblog.com/2025/12/supreme-court-rejects-trumps-effort-to-deploy-national-guard-in-illinois/">Supreme Court blocked the National Guard deployment</a>; the <a href="https://www.wbez.org/government-politics/federal/2025/07/25/chicago-federal-judge-dismisses-doj-lawsuit-over-sanctuary-policies-but-gives-feds-another-chance">DOJ's lawsuit against our sanctuary laws was dismissed</a>. The measurable cost landed on kids: <a href="https://www.chalkbeat.org/chicago/2025/10/31/school-attendance-down-in-latino-immigrant-neighborhoods-amid-ice-operation/">CPS attendance in Latino neighborhoods dropped at double the normal rate</a>, and one Monday ~14,000 students stayed home. My position takes one sentence: the Welcoming City Ordinance stays, city resources never do ICE's job, and a city that defends its people is a city whose people call 911, testify, open businesses, and keep each other safe.</li>
      <li className="policyItem"><b>Historical Justice:</b> A prominent Fred Hampton memorial. The facts are not in dispute: Chicago police fired 90-99 shots into his apartment; the Panthers fired one. The FBI's informant supplied a floor plan marking his bed. The city, county, and federal government settled for $1.85 million in 1982. In 2006 the police union blocked even an honorary street sign, one of over a thousand brown signs in this city, most far less deserving; the city finally unveiled <a href="https://chicago.suntimes.com/black-history/2025/08/31/fred-hampton-street-sign-black-panther-leader">Chairman Fred Hampton Sr. Way in August 2025</a>, 56 years after his assassination. That's a start, not a finish. A city that murdered a 21-year-old visionary owes his memory more than a brown sign; a proper memorial gives the city back a role model.</li>
    </ul>

    <h4 className="groupHead" id="springfield">Springfield Fights</h4>
    <ul className="policies">
      <li className="policyItem"><b>Land Tax Reform:</b> Replace property tax with a land value tax. The principle is simple: land is the one thing nobody made: by holding it you exclude everyone else, so you pay everyone else for the privilege. The building on it is your work, and your work shouldn't be taxed. Today we do the opposite: you're punished for improving your building and rewarded for sitting on a vacant lot, and Chicago has 30,000+ vacant lots held by speculators with zero urgency and zero tax pain. Meanwhile broken assessments shifted <a href="https://www.propublica.org/article/cook-county-property-tax-shift-regressive-assessments">$2.2 billion in property taxes onto the owners of cheaper homes</a>. That's the Tribune and ProPublica's "Tax Divide" investigation, measured by the University of Chicago. Economists across the spectrum call land tax the "least bad tax" (Milton Friedman's words). When Allentown, PA taxed land more than buildings, building permits jumped 32%; Detroit's recent plan projected tax cuts for 97% of homeowners while doubling taxes on speculators. Honest caveat: done fully, this needs an Illinois constitutional amendment, which is why we start the fight now.</li>
      <li className="policyItem"><b>Process Reforms:</b> Ranked-choice voting, open data models, engineering-driven decisions, and the end of the aldermanic veto. RCV now covers ~14 million voters across 49 US jurisdictions, and New York's 2025 primary ran on it with the highest mayoral-primary turnout since 1989. Evanston voted 82% to adopt it, and <a href="https://evanstonroundtable.com/2024/11/14/court-strikes-down-evanstons-ranked-choice-voting-effort/">a court blocked them</a>, ruling Illinois law doesn't allow it. So this is a Springfield fight, and I'm picking it. Bonus: Chicago's two-round system attracted $34 million in campaign ads in 2023; RCV finishes the election in one round. Closer to home, kill aldermanic prerogative: the unwritten rule that one alderman personally controls zoning, permits, even whether your block gets a granny flat. The Burke conviction showed where fiefdoms lead, and our housing shortage shows what they cost. Citywide rules applied citywide, with wards shaping plans in public instead of one person deciding in private. More in the Process Changes section below.</li>
    </ul>

    <h4 className="groupHead" id="experiments">Experiments</h4>
    <ul className="policies">
      <li className="policyItem"><b>BUBI - the City That Invests in You:</b> The experimental half of my income agenda (the proven half is Guaranteed Income, above): the city as a patient investor in its own people. Pay for the nursing degree, the trade certification, the small-business start, and get paid back as a small, capped share of the graduate's future income above a threshold. Honest label: income-share agreements have a rotten private-sector record; regulators had to <a href="https://www.consumerfinance.gov/about-us/newsroom/cfpb-takes-action-against-coding-boot-camp-bloomtech-and-ceo-austen-allred-for-deceiving-students-and-hiding-loan-costs/">force the industry to admit ISAs are loans</a>, and a coding bootcamp got banned from lending for lying about its terms. Every one of those scandals was a company maximizing extraction, which is exactly the argument for a public version with caps written into ordinance and the profit pointed at funding the floor. Full mechanics, a worked example, and the caveats in <a href="#bubi">the BUBI section below</a>.</li>
    ...
    <p>
      Teachers are the other contender for most important resource, and the Teachers plank above is the plan: make Chicago the best city in America to be a new teacher. Young people willing to enter this profession are a sacred resource we should design around: ease them in with incrementally increasing loads and continual guidance from our best, instead of burning out the talent until they quit teaching altogether. Any initial costs are repaid when teachers stay and get better. The best teachers, instead of rising into some admin job, can rise to teaching other teachers, and I'd strongly encourage the hybrid where they still teach at least one regular class. The budget principle underneath it all: maximize the share of every education dollar that reaches a good teacher's classroom, and be willing to name what that implies: removing bad teachers and other obvious wastes of money.
    ...
    <p>
      On closing schools: I understand why the word alone ends conversations here. In 2013 this city closed 50 schools at once, and the research found the promised benefits never arrived for the displaced kids (details in the CPS plank above). That history is precisely why I want the trade-offs worked out in public instead of decided in back rooms. Picture the school system as a map: every school, every kid's commute, every program, every building's condition, all connected. Close one school and the effects ripple across that whole map. We can simulate those ripples before touching anything. So when a school has too few students to serve them well, the process is: show the map, show what changes for each affected family, show the steps that soften the damage, and keep publishing the numbers afterward to prove we didn't cause harm, or to catch it fast if we did. Anyone can check the work and propose better. Equality through math, with the math shown.
    </p>
    <p>
    ...
    <p>
      ...
      <p>
        The daily fixes (train frequency, smarter signals, protected lanes, El signs that just tell you the time) are all in the planks above. This section is the longer game.
      </p>
      <p>North/South bike-only street. And concrete-protected bike lane highways north-south and east-west (the Street Safety plank has the crash data). The bigger ask: map out the active cycling population of Chicago so we can get accurate simulations going and can optimize the bike lane making. This is where I need my Industrial Engineering brothers and sisters to step up and make us an open-source model of the city that anyone can interact with through various interfaces. I want to let people propose alterations based on the results of their changes to the model. Let local people find local improvements.</p>
      ...
      <p>
    Carbon Check- it's like a carbon tax but it isn't a tax because the government gets nothing. We check how much harm people are putting in the air and we charge them. That money goes to a fund, and every month that fund is divided evenly between every citizen. Everyone bears the consequences of these actions, so everyone should be paid to compensate. This can immediately correct incentives. The result? The whole city is incentivized to destroy the world less, at ZERO cost. It's just a transfer. This is simply fair, or more accurately, more fair than today. Because we will not be charging the full cost incurred by your gas use. We will be charging a fraction of the cost, and then dividing that fraction evenly. This may seem obvious or too easy, that's because we are shifting incentives without taking money from the people overall. No more political bullshit, no paying the government. Pure equality. Big gains with zero infrastructure changes. Do it. Do it now. The planet can't wait.
  </p>
  <p>
  ...
  <p>(Strategic landfilling for the people. We build more land at strategic places to expand Chicago eastward onto land that cannot be built upon. It's an investment that greedy politicians or developers of the future can't spoil. Homework I've since done: there's a famous legal wall here called the public trust doctrine, and it was invented on OUR lakefront, in <a href="https://en.wikipedia.org/wiki/Illinois_Central_Railroad_Co._v._Illinois">Illinois Central v. Illinois (1892)</a>, the Supreme Court ruled the state holds the submerged lakebed in trust for the public and couldn't just hand it to a railroad. The same doctrine is what <a href="https://chicago.suntimes.com/2016/6/24/18453574/friends-of-the-parks-score-early-win-in-lawsuit-against-lucas-museum-project">sank the Lucas Museum in 2016</a>. So any new land is public land by construction: parks, beaches, harbors, transit. Which was the point anyway: built-for-the-public-forever is the anti-greed insurance, written right into the deed.)</p>



  <h3 id="bubi">BUBI</h3>
  <p>
    Brains Universal Basic Income. Two Universal Basic Income plans supporting brains, our number 1 resource, hence BUBI: a floor, and a ladder.
  </p>
  <p>
    First off, the floor: traditional Universal Basic Income, or General for GUBI. If we provide financial stability, we are providing Safety, we are enabling Education, we are giving people the power to choose the direction of their lives. Giving people money is simply the best way to help people in need because they know what they need. That's just a fact we've learned from studies, and developing policy otherwise would be ugly pride with no purpose. So we set up some sort of graduated system so you get less the more you make. One of the variables in that system is how much we contribute. We can set up a structure and start today, there is no minimum amount necessary. The base principle here is the equanimity of brains. GUBI is basically a well-defined bucket we can choose to allocate funds to, or people could donate to. Something you can trust, and seriously reduces the government's ability to mess things up. You know you will be directly supporting other people in your city who have less, and in fair proportion and minimal waste. (The receipts are in the Guaranteed Income plank above: Chicago's 5,000-household pilot, Cook County going permanent in 2025, and how our city quit mid-application.)
  </p>
  <p>
  ...
  <p>
    The second half of BUBI is my own creation. It is the city acting as an income-share investor in its own people. You bring a plan that creates value (a credential, a business, work the city needs) and the city fronts the money; you pay it back later as a small share of your income above a threshold. A worked example: a certified nursing assistant wants to become a registered nurse. Tuition is roughly $30,000 she doesn't have, and an RN in Chicago out-earns a CNA by $40,000+ a year. The city pays the $30,000. In return, once her income passes $50,000, she pays the city 5 cents of every dollar above that line for ten years: a few thousand a year in the good years, zero in the bad ones, capped so she never repays more than twice the investment. She is never underwater, the city roughly doubles its money over time, and every repaid dollar funds the floor (GUBI) or the next investment. You can have as many brackets as you want; a job that contributes to everyone's health helps your petition, but you can pitch anything if the numbers align. At first, Chi-GUI (with human approval on every deal) starts ruthless; it only has so much money, so it funds the clear doubles. Each success eventually funds two more, and as it grows it can give better deals. It still wants to profit, because profit goes to GUBI.
  </p>
  <p>
    Now the honest caveat, because the private sector already poisoned this well: income-share agreements have been a consumer-protection disaster. Regulators had to force the industry to <a href="https://www.consumerfinance.gov/archive/newsroom/cfpb-takes-action-against-student-lender-for-misleading-borrowers-about-income-share-agreements/">admit ISAs are loans</a>; <a href="https://www.insidehighered.com/news/2022/06/23/purdue-pauses-new-income-share-agreement-enrollments">Purdue shut its program down</a> after students ended up repaying 2.5x; the Lambda School bootcamp got <a href="https://www.consumerfinance.gov/about-us/newsroom/cfpb-takes-action-against-coding-boot-camp-bloomtech-and-ceo-austen-allred-for-deceiving-students-and-hiding-loan-costs/">banned from lending for lying about its terms</a>. Notice the common thread: every scandal was a company maximizing extraction. A public version inverts the incentive: caps written into ordinance, terms in plain English, zero owed below the threshold, and the "profit" motive pointed at funding the floor. That's not a loophole in my plan; that IS the plan.
  </p>
  <p>
 ...
 <h3 id="process">Process changes</h3>
  ...
  <h2 id="parking-rant">(Bonus Parking Rant)</h2>
...
/* Policy group headers: small caps in the UI font, so they read as
   wayfinding rather than competing with the section titles. */
.groupHead {
  font-family: 'Instrument Sans', 'Avenir', Helvetica, Arial, sans-serif;
  font-size: 1rem;
  font-weight: 600;
