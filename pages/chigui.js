...
<div className="container">
  ...
  <div style={{display:'flex', flexDirection:'column', justifyContent:'center', alignItems:'center', marginBottom: '5%'}}>
    ...
    <button onClick={() => setExpandedDef(!expandedDef)}>
        ...
        {expandedDef && (
          <>
    <p>Buddhism has an analog to the scientific method, the 4 Noble Truths. I want to apply this to every city issue, a basic template for progressing logic. You have probably heard something like 'life is suffering', and the Noble Truths are about "suffering", but that's misleading. Everything in life is impermanent, that's the nature of our universe. That impermanence causes suffering. This is a problem solving framework for ongoing issues.</p>
